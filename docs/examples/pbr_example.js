...
let cPos = vec3.fromValues(0.5, 8, 9.0);
let cUp = vec3.fromValues(0, 1, 0);
let cFront = vec3.fromValues(0, 0, -1);
let light_color = vec3.fromValues(12.47, 12.31, 12.79);
let light_positions = [
...
function onProgress(loaded_bytes, total_bytes, file_name) {
    let name = file_name;
...
function onFileComplete(file_name) {
